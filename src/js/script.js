window.onload =  () => {
    const newBook = (container) =>{
        var books_availables =  [
          ...
          book_to_add = books_availables[Math.random(0, books_availables.length-1)]
      
          document.getElementById('descripcion_'+container).innerHTML = book_to_add.description
          ...
          var newBookSpace = document.createElement("div")
          
          
          var book_image_element = document.createElement("img")
          book_image_element.src = book_to_add.image
          book_image_element.alt = "portada"
          book_image_element.className = "portada_imagen"
          newBookSpace.appendChild(book_image_element)
      
          var overlay = document.createElement("div")
          overlay.className = "overlay_portada"
          var div_txt_in_overlay = document.createElement("div")
          div_txt_in_overlay.className = "text"
